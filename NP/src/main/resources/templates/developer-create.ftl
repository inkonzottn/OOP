...
<head>
    <meta charset="UTF-8">
    <title>Додати розробника | DevSync</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold m-0">Новий розробник</h2>
            </div>

            <div class="card p-4">
                <form action="/admin/developers/create" method="post">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.firstName"
                                   ...
                                   value="${(developer.user.firstName)!''}" placeholder="Майк">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.lastName"
                                   ...
                                   value="${(developer.user.lastName)!''}" placeholder="Вазовскі">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="user.email"
                                       ...
                                       value="${(developer.user.email)!''}" placeholder="mike">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="hourlyRate"
                                   ...
                                   value="${(developer.hourlyRate)!''}" min="1">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-save">Створити розробника</button>
                    </div>
                </form>
            </div>
        </div>
