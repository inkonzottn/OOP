...
<head>
    <meta charset="UTF-8">
    <title>Додати менеджера | DevSync</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                <a href="/admin/managers" class="btn btn-light rounded-circle me-3">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <h2 class="fw-bold m-0">Новий менеджер</h2>
            </div>

            <div class="card p-4">
                <form action="/admin/managers/create" method="post">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.firstName"
                                   ...
                                   value="${(manager.user.firstName)!''}" placeholder="Майк">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.lastName"
                                   ...
                                   value="${(manager.user.lastName)!''}" placeholder="Вазовскі">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="user.email"
                                       ...
                                       value="${(manager.user.email)!''}" placeholder="mike">
                                <span class="input-group-text">@devsync.mng.com</span>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="/admin/managers" class="btn btn-light px-4">Скасувати</a>
                        <button type="submit" class="btn btn-save">Створити менеджера</button>
                    </div>
                </form>
            </div>
        </div>
