...
<head>
    <meta charset="UTF-8">
    <title>Редагувати менеджера | DevSync</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold m-0">Редагування менеджера</h2>
            </div>

            <div class="card p-4">
                <form action="/admin/managers/edit/${manager.id}" method="post">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.firstName"
                                   ...
                                   value="${(manager.user.firstName)!''}" placeholder="Ім'я">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="user.lastName"
                                   ...
                                   value="${(manager.user.lastName)!''}" placeholder="Прізвище">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="user.email"
                                       ...
                                       value="${(manager.user.email?keep_before("@"))!''}"
                                       placeholder="mike">
